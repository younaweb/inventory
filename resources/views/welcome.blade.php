			...
			<div class="main-header" data-background-color="purple">
				...
				<div class="logo-header">
					...
					<a href="index.html" class="logo">
						<img src="{{asset('docs/img/logoazzara.svg')}}" alt="navbar brand" class="navbar-brand">
					</a>
						...
						<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
									...
									<li>
										<div class="message-notif-scroll scrollbar-outer">
											<div class="notif-center">
												<a href="#">
													<div class="notif-img">
														<img src="{{asset('docs/img/jm_denis.jpg')}}" alt="Img Profile">
													</div>
												...
												<a href="#">
													<div class="notif-img">
														<img src="{{asset('docs/img/chadengle.jpg')}}" alt="Img Profile">
													</div>
													<div class="notif-content">
												...
												<a href="#">
													<div class="notif-img">
														<img src="{{asset('docs/img/mlane.jpg')}}" alt="Img Profile">
													</div>
													<div class="notif-content">
												...
												<a href="#">
													<div class="notif-img">
														<img src="{{asset('docs/img/talha.jpg')}}" alt="Img Profile">
													</div>
													<div class="notif-content">
									...
									<li>
										<div class="notif-scroll scrollbar-outer">
											<div class="notif-center">
												...
												<a href="#">
													<div class="notif-img">
														<img src="{{asset('docs/img/profile2.jpg')}}" alt="Img Profile">
													</div>
													<div class="notif-content">
														<span class="block">
							...
							<li class="nav-item dropdown hidden-caret">
								<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
									<div class="avatar-sm">
										<img src="{{asset('docs/img/profile.jpg')}}" alt="..." class="avatar-img rounded-circle">
									</div>
								</a>
								<ul class="dropdown-menu dropdown-user animated fadeIn">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="{{asset('docs/img/profile.jpg')}}" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
